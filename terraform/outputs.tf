...
output "db_instance_endpoint" {
  description = "O endereço de conexão (endpoint) da instância RDS."
...
output "master_user_secret_arn" {
  description = "O ARN do segredo do Secrets Manager que contém as credenciais do usuário mestre."
